  ...
  //heappages = sbrk(4096*1);
    ...
    for (int i = 0; i < 1; i++) {
        ...
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 1 - before setting. \n", *a);
        ...
        printf("New val at heap = %d :: From func 1 - after setting. \n", *a);
    }
  ...
  int *a1;
    ...
    for (int i = 0; i < 1; i++) {
        ...
        a1 = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 2 - before setting. \n", *a1);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a1 = data;
            a1++;
        }
        a1 = ((int*) (heappages + i*PGSIZE));
        printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 2 - after setting. \n", *a1);
    }
    for(int i = 0; i < 100000000; i++);
    urelease(&data_lock);
  ...
  int *a;
    ...
    data = 400;
     for (int i = 0; i < 1; i++) {
        //printf("Val at i = %d :: From func 1\n", *a);
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 3 - before setting. \n", *a);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        }
        a = ((int*) (heappages + i*PGSIZE));
        printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 3 - after setting\n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
  ...
  int *a;
    ...
    data = 500;
      for (int i = 0; i < 1; i++) {
        //printf("Val at i = %d :: From func 1\n", *a);
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 4 - before setting. \n", *a);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        }
        a = ((int*) (heappages + i*PGSIZE));
         printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 4 - after setting. \n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
  ...
  int* a;
    ...
    data = 600;
      for (int i = 0; i < 1; i++) {
        //printf("Val at i = %d :: From func 1\n", *a);
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 5 - before setting. \n", *a);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        }
        a = ((int*) (heappages + i*PGSIZE));
         printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 5 - after setting. \n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
  ...
  int* a;
    ...
    data = 700;
      for (int i = 0; i < 1; i++) {
        //printf("Val at i = %d :: From func 1\n", *a);
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 6 - before setting. \n", *a);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        }
        a = ((int*) (heappages + i*PGSIZE));
         printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 6 - after setting. \n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
  ...
  int* a;
    ...
    data = 800;
      for (int i = 0; i < 1; i++) {
        //printf("Val at i = %d :: From func 1\n", *a);
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 7 - before setting. \n", *a);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        }
        a = ((int*) (heappages + i*PGSIZE));
         printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 7 - after setting. \n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
  ...
  int* a;
    ...
    data = 900;
      for (int i = 0; i < 1; i++) {
        //printf("Val at i = %d :: From func 1\n", *a);
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 8 - before setting. \n", *a);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        }
        a = ((int*) (heappages + i*PGSIZE));
         printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 8 - after setting. \n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
  ...
  int* a;
    ...
    data = 1000;
      for (int i = 0; i < 1; i++) {
        //printf("Val at i = %d :: From func 1\n", *a);
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 9 - before setting. \n", *a);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        }
        a = ((int*) (heappages + i*PGSIZE));
         printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 9 - after setting. \n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
  ...
  int* a;
    ...
    data = 1100;
      for (int i = 0; i < 1; i++) {
        //printf("Val at i = %d :: From func 1\n", *a);
        a = ((int*) (heappages + i*PGSIZE));
         printf("Prev val at heap = %d :: From func 10 - before setting. \n", *a);
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        }
        a = ((int*) (heappages + i*PGSIZE));
         printf("Setting data = %d\n", data);
        printf("New val at heap = %d :: From func 10 - after setting. \n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
...
void start_func_11(void) {
  int* a;
    ...
    data = 1200;
      for (int i = 0; i < 1; i++) {
        printf("Prev val at heap = %d :: From func 11 - before setting. \n", *a);
        a = ((int*) (heappages + i*PGSIZE));
        for (int j = 0; j < PGSIZE/sizeof(int); j++) {
            *a = data;
            a++;
        ...
        a = ((int*) (heappages + i*PGSIZE));
        printf("New val at heap = %d :: From func 11 - after setting. \n", *a);
    }
    for(int i = 0; i < 1000000000; i++);
    urelease(&data_lock);
...
main(int argc, char *argv[])
{
    ...
    printf("[*] OS-Assisted Threading Test #4 Complete.\n");
    return 0;
}
